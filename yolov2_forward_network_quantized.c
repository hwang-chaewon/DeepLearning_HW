    ...
    for (j = 0; j < net.n; ++j) {
        ...
        */
        ...
        if (l->type == CONVOLUTIONAL) { // Quantize conv layer only
            ...
            l->input_quant_multiplier = (counter < net.input_calibration_size) ? net.input_calibration[counter] : 8;  // Using 16 as input_calibration as default value
